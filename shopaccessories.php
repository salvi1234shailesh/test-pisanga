    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-2 col-md-4 portfolio-item filter-web">
            <img src="assets/accessories/IMG_2236.jpg"  class="img-fluid" alt="" style="width:100%;">
            <div class="portfolio-info">
              <h5>Plate Connector</h5>
              <a href="assets/accessories/IMG_2236.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
              <a href="#" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
