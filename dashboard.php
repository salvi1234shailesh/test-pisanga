...
$sql="select count('1') from profile";
...
<right><i class="bx bxs-inbox"></i></right> </right>
        </h5>
...
$sql="select count('1') from custregisteration";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
mysqli_close($mysqli);
?> <right><i class="fa fa-user" style="font-size:25px;"></i></right></h5>
        <p class="card-text">Customer Registration</p>
...
echo "<h3>$row[0]</h3>";
mysqli_close($mysqli);
?><right><i class="bx bxs-building"></i></right> </h5>
