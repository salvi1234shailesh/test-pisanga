...
">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Conveyor System</li>
  </ol>
</nav> 
				    </div>
				</div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <form action="send_mail.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
