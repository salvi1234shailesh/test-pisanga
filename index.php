...
<head>
  ...
  <title>Pisanga Aluminium Extrusions</title>
   ...
   <meta name="descriptison" content="aluminium extrusion buy,aluminium extrusion catalogue,aluminium extrusion companies in india,aluminium extrusion companies in maharashtra,aluminium extrusion local
aluminium extrusion machine">
  <meta name="keywords" content="aluminium extrusion buy,aluminium extrusion catalogue,aluminium extrusion companies in india,aluminium extrusion companies in maharashtra,aluminium extrusion local
aluminium extrusion machine">
<link rel="canonical" href="http://pisanga.com/index.php" />

<script type="application/ld+json">
{
	"@context": "http://schema.org",
	"@type": "Organization",
	"name": "Pisanga Aluminium Extrusions",
	"description": "Pisanga as an organisation has a luxury that it is run by the energy of youths. Their knowledge, creativity, dedication and liberal minds are the building block of our company.

We at Pisanga build products of aluminium extrusions that have a good aesthetic design and strong manufacturing. Products like Industrial Workstations and Conveyor. Assembly System are the primary products. We also supply varied aluminium extrusions and their connecting accessories.

Best client service and good relation are all that we achieve with our clients. We are driven by a basic fundamental value, that whatever we create it should be ’Strong and Beautiful ’ as it is true for our product it is true with our relations.",
	"image": "http://pisanga.com/assets/img/Logo/PNG/60%20px.png",
	"logo": "http://pisanga.com/assets/img/Logo/PNG/60%20px.png",
	"url": "http://pisanga.com/index.php",
	"telephone": "+91 9096115174 ",
	"sameAs": ["https://twitter.com/pisangaindia","https://www.linkedin.com/in/pisangaindia/","https://www.facebook.com/pisangaindia","https://www.youtube.com/channel/UCniThUViI4QX13MJKCE8xsw","https://www.instagram.com/pisanga_india/"],
	"address": {
		"@type": "PostalAddress",
		"streetAddress": "Sr 64, Kalbhor Estate Opp Ador Welding, ",
...
<script type="text/javascript">
    (function () {
        var options = {
            ...
            whatsapp: "919096115174", // WhatsApp number
...
<body>
			...
			<nav class="nav-menu d-none d-lg-block">
				<ul>
					...
					<li class="drop-down"><a href="">Products</a>
						<ul>
						  <li><a href="alumin_profile.php">Alumin Profile & Accessories</a></li>
                        ...
                        <div class="row"  data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4414.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4414</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px;text-align:center; ">Add Cart </a></span>
                                    </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4445.jpg">
                                    <div class="card-body">
                                       <h4 class="card-title">Profile No 4445</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  text-center " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px;text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src=" assets/aluminprofile/4465.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4465</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px;text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                             ...
                             <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src=" assets/aluminprofile/4474.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4474</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px;text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                    ...
                    <div class="carousel-item">
                        <div class="row"  data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4404.jpg">
                                    <div class="card-body">
                                       <h4 class="card-title">Profile No 4404</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px;text-align:center; ">Add Cart </a></span>
                                    </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4412.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4412</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px;text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4413.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4413</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center;">Add Cart </a></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4430.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4430</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center;">Add Cart </a></span>
                                    </div>
                                </div>
                    ...
                    <div class="carousel-item  ">
                        <div class="row"  data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4464.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4464</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                                    </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4469.jpg">
                                    <div class="card-body">
                                       <h4 class="card-title">Profile No 4469</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src=" assets/aluminprofile/4415.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4414</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src=" assets/aluminprofile/4416.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4416</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                    ...
                    <div class="carousel-item">
                        <div class="row"  data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4468.jpg">
                                    <div class="card-body">
                                       <h4 class="card-title">Profile No 4468</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                                    </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4452.jpg">
                                    <div class="card-body">
                                        <h4 class="card-title">Profile No 4452</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4470.jpg">
                                    <div class="card-body">
                                       <h4 class="card-title">Profile No 4470</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card text-center">
                                    <img class="img-fluid" alt="100%x280" src="assets/aluminprofile/4439.jpg">
                                    <div class="card-body">
                                       <h4 class="card-title">Profile No 4414</h4>
                                        <p class="card-text"></p>
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; text-align:center; ">Add Cart </a></span>
 ...
 <span> <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; ">Add Cart </a></span>
          ...
          <div class="col-lg-3 col-md-6">
             <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="assets/aluminprofile/4412.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
              <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="assets/img/aluminprofile/4430.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
      ...
      <div class="container">
        ...
        <div class="row no-gutters" data-aos="fade-left">
          ...
          <div class="col-lg-12 col-md-4 text-center">
             <a href="shop.php" class="btn-get-started scrollto  " style="background: #010246;border: 0; padding: 10px 30px;color: #fff; border-radius:50px; ">See For More Product </a>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4 col-xm-12 col-sm-12" data-aos="fade-right">
            <img src="assets/workstation/workstation3-min.jpg" class="img-fluid" alt="" style="width:180%">
          </div>
		  <div class="col-md-4 col-xm-12 col-sm-12" data-aos="fade-right">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-2 col-md-4 portfolio-item filter-web">
            ...
            <div class="portfolio-info" style="text-align:center;">
              ...
              <a href="assets/accessories/IMG_2232.JPG" data-gall="portfolioGallery" class="venobox preview-link" title="Web 3"> <!--<i class="bx bx-plus"></i>--></a>
               <!--<a href="#" class="details-link" title="More Details"><i class="bx bx-link"></i></a>-->
            </div>
          </div>
          ...
          <div class="col-lg-2 col-md-4 portfolio-item filter-web">
            ...
            <div class="portfolio-info" style="text-align:center;">
              <h5>Square Washer</h5>
              <a href="assets/img/accessories/IMG_2256.JPG" data-gall="portfolioGallery" class="venobox preview-link" title="Web 3"> <!--<i class="bx bx-plus"></i>--></a>
               <!--<a href="#" class="details-link" title="More Details"><i class="bx bx-link"></i></a>-->
            </div>
          </div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4" id="client_r">
					<img src="assets/client/download (1).jpg" class="img-fluid" alt="" id="client_media">
				</div>
