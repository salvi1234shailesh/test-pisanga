...
">
  ...
  <a href="add_product.php" class="list-group-item list-group-item-action">Add Product Profile</a>
...
?> 
                      <tr>
                        ...
                        <td><?php echo $row['profile_no'] ?></td>
                         <td> <a href='<?php echo $row['profile_image'] ?> ' target='_blank' class='btn btn-primary'>View Photo</a>  </td>

                         <td> <?php echo $row['profile_sr_no'] ?> </td>
                  
                         <td> <?php echo $row['profile_cost'] ?> </td>
                  
                        <td><?php echo $row['discounts'] ?></td>

                        <td> <a href="update_product.php?id=<?php echo $row['id'] ?>"> <i class="fa fa-pencil" style="font-size:25px;"></i> </a>&nbsp; &nbsp;
                        <a href="delete_product.php?id=<?php echo $row['id'] ?>"> <i class="fa fa-trash" style="font-size:25px; color:red;"></i> </a>
                         </td>
