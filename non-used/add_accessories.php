...
$target_dir = "Accessories/";
  $imageFileType = strtolower(pathinfo(basename($_FILES["access_image"]["name"]),PATHINFO_EXTENSION));
$target_file = $target_dir . time() . "." . $imageFileType;


  move_uploaded_file($_FILES["access_image"]["tmp_name"], $target_file);
...
$access_cost = $_POST['access_cost'];

$access_discount = $_POST['access_discount'];

$access_image =$target_file ;
 ...
 $mysql1= mysqli_query($conn, "SELECT * FROM accessories WHERE access_name = '$access_name'" );
...
$sql = "INSERT INTO `accessories`(`access_category`, `access_name`, `access_image`, `access_cost`, `access_discount`, `cr_date`) 

VALUES ('$access_category','$access_name','$access_image','$access_cost','$access_discount', now())";

//    echo $sql;
// die;

if (mysqli_query($conn, $sql)) {
  echo '<script>alert("Successful! Submitted Accessories Product  .");
...
<a href="add_accessories.php" class="list-group-item list-group-item-action active">Add Product Accessories</a>
<a href="view_accessories.php" class="list-group-item list-group-item-action">View Product Accessories</a>
  ...
  <form action="" method="post" role="form" class="form-material" 
                                                     enctype="multipart/form-data"  >
                                                      ...
                                                      enctype="multipart/form-data">
                                                       ...
                                                       <label class="float-label">Accessories Category</label>
                                                              <input type="text" name="access_category" class="form-control" required="" placeholder="Enter the category Accessories ">
                                                          ...
                                                          <div class="form-group form-default">
                                                          <label class="float-label">Accessories Name</label>
                                                              <input type="text" name="access_name" class="form-control" required="" placeholder="Enter the  Accessories Product Name ">
                                                              <span class="form-bar"></span>
                                                              
                                                          </div>
                                                           <div class="form-group form-default">
                                                     
                                                           <label class="float-label"> Accessories Image</label>
                                                        <input type="file" name="access_image" id="access_image" class="form-control" placeholder="Enter Accessories Image" accept="image/png, image/jpeg, image/jpg" required>
                                                           ...
                                                           <div class="form-group form-default">
                                                           <label class="float-label">Accessories Cost</label>
                                                              <input type="text" name="access_cost" class="form-control" required="" placeholder="Enter the  Accessories Product Cost ">
                                                              <span class="form-bar"></span>
                                                            
                                                          </div>
                                                           <div class="form-group form-default">

                                                           <label class="float-label"> Accessories Cost Discount</label>
                                                              <input type="text" name="access_discount" class="form-control" required="" placeholder="Enter the  Accessories Product Cost Discount" >
                                                              <span class="form-bar"></span>
                                      ...
                                      <div class="col-md-12">
                                          <input type="submit"   name="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" value="Add Accessories">
                                      </div>
                                  </div>
