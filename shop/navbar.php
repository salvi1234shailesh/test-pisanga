...
<nav class="navbar navbar-expand-md   navbar-dark" style="background-color:rgba(1, 4, 136, 0.9);">
  <!-- Brand -->
  <a class="navbar-brand" href="#"><span><img src="../assets\img\Logo\PNG\60 px.png" class="" alt="">&nbsp;<img src="assets\img\Logo\Pisanga FINAL version-09.png" class="" alt=""></span></a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item"><a class="nav-link" href="../alumin_profile.php">Alumin Profile & Accessories</a></li>
						  <li  class="nav-item"><a class="nav-link" href="../shopworkstation.php">  Workstation</a></li>
						  <li  class="nav-item"><a class="nav-link" href="../shopconveyor.php"> Conveyor</a></li>  
