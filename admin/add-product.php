...
<head>
  ...
  <title>Pisanga Admin - Add Product</title>
          ...
          <form action="ins_product.php" method="post" enctype="multipart/form-data">
            ...
            <p><select name="cat" class="form-control">
              <option value="">-Select-</option>
                <option value="3" data="3">30 MM Series</option>
                <option value="4" data="4">40 MM Series </option>
                <option value="5" data="5">45 MM Series</option>
                <option value="6" data="6">Nut </option>
