...
<head>
  ...
  <title>Pisanga Admin - Update Category</title>
  <!-- Favicons -->
...
while($row=$rs->fetch_assoc()){
 ...
 <p>
<input type="hidden" name="id" class="form-control" value="<?php  echo $id;?>"></p>
            ...
            <p>Category</p>
            <p><input type="text" name="cat" class="form-control" value="<?php echo $row['name'];  ?>"><?php echo $row['name'];  ?></p>
