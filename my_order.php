...
//echo $user_id; 
 ...
 $sql = "SELECT * FROM `order_info` WHERE user_id='$user_id'";
...
<h3 class="title2">My Order Address Details</h3>
...
?> 
                        ...
                        <tr>
                             ...
                             <td><a class="btn btn-success" href="my_order_details.php?user_id=<?php echo $row['user_id'] ?>"><i class="ti-pencil" style="color:blue;"></i>View Order</a></td>
