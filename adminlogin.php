...
<body>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 head pt-3 pb-3">
                ...
                <h1 style="color:#808A8A;text-align:center; margin-top:20px;">Welcome to Pisanaga.com</h1>
            </div>


            <div class="col-lg-12 col-md-12 col-sm-12 login">
                <h1 style="text-align:center;margin-top:20px; color:#808A8A">Admin Login</h1>
            </div>
            ...
            <form action="adminlogin.php" method="post" >
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Email Address</label>
                   <input style="margin-top:25px; border-radius:5px " type="text" class="form-control" style="height:40px;" type="email" class="form-control" name="email" id="username" placeholder="Your Email"  required  autofocus/>
  ...
  <label for="exampleInputEmail1">Password</label>
                   <input type="password" class="form-control" name="password" id="password" placeholder="Your password" style="margin-top:25px; border-radius:5px " type="text" class="form-control" style="height:40px;"  required />
              ...
              <input type="submit" name="submit" class="btn btn-success btn-round mx-auto" style="border: 0; padding: 10px 30px;color: #fff; border-radius:50px; ">
     ...
     <footer class="footer" style="background: blue;position: absolute;width: 100%; padding: 10px 0;  padding-top:1%;">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12 text-center">
        <p style="color: #fff;">Pisanga &copy;-2021</p>
      </div>
